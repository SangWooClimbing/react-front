...
import { MapPinIcon, GlobeAltIcon, UserGroupIcon, StarIcon } from '@heroicons/react/24/solid'; // Replaced ChartBarIcon with StarIcon for rating
...
const GymCard: React.FC<GymCardProps> = ({ gym }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden w-80 md:w-96 flex-shrink-0 transform hover:scale-105 transition-transform duration-300 ease-in-out">
      ...
      <div className="p-5">
        <div className="flex items-center mb-3">
          ...
          <div>
            <h3 className="text-xl font-bold text-slate-800 hover:text-primary transition-colors cursor-pointer">{gym.name}</h3>
        ...
        <div className="space-y-2 text-sm mb-4">
          {/* Removed Total Routes */}
          <div className="flex items-center text-slate-700">
            <StarIcon className="h-5 w-5 mr-2 text-accent" /> {/* Using StarIcon for rating */}
